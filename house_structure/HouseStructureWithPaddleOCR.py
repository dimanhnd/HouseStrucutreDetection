...
class HouseStructure:
    ...
    def remove_text(self, img_path):
        ...
        result[text_mask == 255] = (255, 255, 255)  # Fill text regions with white color
        return result
...
folder_path = './madori'
result_folder = './result_img_paddleOcr'
...
for filename in os.listdir(folder_path):
    if filename.endswith(('.jpg', '.png', '.jpeg')):  # Filter images based on extensions
        ...
        # Save edge image to result folder
        edge_image_path = os.path.join(result_folder, f'{os.path.splitext(filename)[0]}.jpg')
